...
public class StudentQuizAnswerController {
	...
	public List<StudentQuizAnswer> getAnsForStQuizResAndQuestion(@PathVariable Long stQuizResId, @PathVariable Long questId) {
	...
	@PreAuthorize("hasRole ('STUDENT')")
	@DeleteMapping("/{ansId}")
	public void deleteStudentAnswer(@PathVariable Long ansId) {
		stQuizAnswerService.deleteAnswer(ansId);
	}
